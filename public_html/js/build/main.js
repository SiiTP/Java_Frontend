...
define('sync',['backbone'], function(Backbone) {
...
define('tmpl/login',[],function () { return function (__fest_context){"use strict";var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_htmlchars=/[&<>"]/g,__fest_htmlchars_test=/[&<>"]/,__fest_short_tags = {"area":true,"base":true,"br":true,"col":true,"command":true,"embed":true,"hr":true,"img":true,"input":true,"keygen":true,"link":true,"meta":true,"param":true,"source":true,"wbr":true},__fest_element_stack = [],__fest_htmlhash={"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;"},__fest_jschars=/[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test=/[\\'"\/\n\r\t\b\f<>]/,__fest_jshash={"\"":"\\\"","\\":"\\\\","/":"\\/","\n":"\\n","\r":"\\r","\t":"\\t","\b":"\\b","\f":"\\f","'":"\\'","<":"\\u003C",">":"\\u003E"},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_replaceHTML(chr){return __fest_htmlhash[chr]}function __fest_replaceJS(chr){return __fest_jshash[chr]}function __fest_extend(dest, src){for(var i in src)if(src.hasOwnProperty(i))dest[i]=src[i];}function __fest_param(fn){fn.param=true;return fn}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}function __fest_escapeJS(s){if (typeof s==="string") {if (__fest_jschars_test.test(s))return s.replace(__fest_jschars,__fest_replaceJS);} else if (typeof s==="undefined")return "";return s;}function __fest_escapeHTML(s){if (typeof s==="string") {if (__fest_htmlchars_test.test(s))return s.replace(__fest_htmlchars,__fest_replaceHTML);} else if (typeof s==="undefined")return "";return s;}__fest_buf+=("<div class=\"login\"><div class=\"header-noBorder\"><div class=\"header-text\">Авторизация</div><div class=\"line line_blue\"></div></div><form id=\"login-form\" method=\"post\"><div class=\"input-field\"><div class=\"input-line\"><label for=\"username\" class=\"input-line__header\">Логин</label><input class=\"input-line__input js-login__input-field-username__input-line__input\" type=\"text\" name=\"username\" id=\"username\"/></div><div class=\"validation-info js-login__input-field-username__validation-info\">Введите ваш логин.</div><div class=\"line js-login__input-field-username__line\"></div></div><div class=\"input-field\"><div class=\"input-line input-line-password\"><label for=\"password\" class=\"input-line__header\">Пароль</label><input class=\"input-line__input js-login__input-field-password__input-line__input\" type=\"password\" name=\"password\" id=\"password\"/></div><div class=\"validation-info js-login__input-field-password__validation-info\">Введите ваш пароль.</div><div class=\"line js-login__input-field-password__line\"></div></div><div class=\"login__buttons-container\"><button type=\"submit\" class=\"button login__buttons-container__button\">Войти</button><a class=\"login__buttons-container__registration-link\" href=\"#registration\">Регистрация</a></div></form><div class=\"validation-info validation-info_error validation-info-common login__validation-info-common\"></div></div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}} ; });
...
define('tmpl/registration',[],function () { return function (__fest_context){"use strict";var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_htmlchars=/[&<>"]/g,__fest_htmlchars_test=/[&<>"]/,__fest_short_tags = {"area":true,"base":true,"br":true,"col":true,"command":true,"embed":true,"hr":true,"img":true,"input":true,"keygen":true,"link":true,"meta":true,"param":true,"source":true,"wbr":true},__fest_element_stack = [],__fest_htmlhash={"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;"},__fest_jschars=/[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test=/[\\'"\/\n\r\t\b\f<>]/,__fest_jshash={"\"":"\\\"","\\":"\\\\","/":"\\/","\n":"\\n","\r":"\\r","\t":"\\t","\b":"\\b","\f":"\\f","'":"\\'","<":"\\u003C",">":"\\u003E"},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_replaceHTML(chr){return __fest_htmlhash[chr]}function __fest_replaceJS(chr){return __fest_jshash[chr]}function __fest_extend(dest, src){for(var i in src)if(src.hasOwnProperty(i))dest[i]=src[i];}function __fest_param(fn){fn.param=true;return fn}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}function __fest_escapeJS(s){if (typeof s==="string") {if (__fest_jschars_test.test(s))return s.replace(__fest_jschars,__fest_replaceJS);} else if (typeof s==="undefined")return "";return s;}function __fest_escapeHTML(s){if (typeof s==="string") {if (__fest_htmlchars_test.test(s))return s.replace(__fest_htmlchars,__fest_replaceHTML);} else if (typeof s==="undefined")return "";return s;}__fest_buf+=("<div class=\"registration\"><div class=\"header-noBorder\"><h1 class=\"header-text\">Регистрация</h1><div class=\"line line_blue\"></div></div><form id=\"registration-form\" method=\"post\"><div class=\"input-field input-field-username\"><div class=\"input-line\"><label for=\"username\" class=\"input-line__header\">Логин</label><input class=\"input-line__input registration__input-field-username__input-line__input\" type=\"text\" name=\"username\" id=\"username\"/></div><div class=\"validation-info registration__input-field-username__validation-info\">Введите ваш логин. От 4 до 9 латинских букв</div><div class=\"line registration__input-field-username__line\"></div></div><div class=\"input-field input-field-password\"><div class=\"input-line input-line-password\"><label for=\"password\" class=\"input-line__header\">Пароль</label><input class=\"input-line__input  registration__input-field-password__input-line__input\" type=\"password\" name=\"password\" id=\"password\"/></div><div class=\"validation-info registration__input-field-password__validation-info\">Введите ваш пароль. От 4 до 16 латинских букв, цифр и символов нижнего подчеркивания</div><div class=\"line registration__input-field-password__line\"></div></div><div class=\"input-field input-field-confirm\"><p class=\"input-line input-line-confirm\"><label for=\"confirm\" class=\"input-line__header\">Еще раз</label><input class=\"input-line__input registration__input-field-confirm__input-line__input\" type=\"password\" name=\"confirm\" id=\"confirm\"/></p><div class=\"validation-info registration__input-field-confirm__validation-info\">Повторите введенный пароль</div><div class=\"line registration__input-field-confirm__line\"></div></div><button type=\"submit\" class=\"button registration__button\">Зарегистрироваться</button></form><button class=\"button button_long smallMargTop js-button-onMain\" data-href=\"#\">На главную</button><div class=\"validation-info validation-info-common registration__validation-info-common validation-info_error \"></div></div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}} ; });
//форма регистрации
...
define('tmpl/scoreboard',[],function () { return function (__fest_context){"use strict";var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_htmlchars=/[&<>"]/g,__fest_htmlchars_test=/[&<>"]/,__fest_short_tags = {"area":true,"base":true,"br":true,"col":true,"command":true,"embed":true,"hr":true,"img":true,"input":true,"keygen":true,"link":true,"meta":true,"param":true,"source":true,"wbr":true},__fest_element_stack = [],__fest_htmlhash={"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;"},__fest_jschars=/[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test=/[\\'"\/\n\r\t\b\f<>]/,__fest_jshash={"\"":"\\\"","\\":"\\\\","/":"\\/","\n":"\\n","\r":"\\r","\t":"\\t","\b":"\\b","\f":"\\f","'":"\\'","<":"\\u003C",">":"\\u003E"},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_replaceHTML(chr){return __fest_htmlhash[chr]}function __fest_replaceJS(chr){return __fest_jshash[chr]}function __fest_extend(dest, src){for(var i in src)if(src.hasOwnProperty(i))dest[i]=src[i];}function __fest_param(fn){fn.param=true;return fn}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}function __fest_escapeJS(s){if (typeof s==="string") {if (__fest_jschars_test.test(s))return s.replace(__fest_jschars,__fest_replaceJS);} else if (typeof s==="undefined")return "";return s;}function __fest_escapeHTML(s){if (typeof s==="string") {if (__fest_htmlchars_test.test(s))return s.replace(__fest_htmlchars,__fest_replaceHTML);} else if (typeof s==="undefined")return "";return s;}var scores=__fest_context;__fest_buf+=("<div class=\"scoreboard\"><div class=\"header-text\">Топ-10</div><div class=\"table\"><header class=\"scoreboard__table__table-header\"><div class=\"scoreboard__table__table-header__item\">Логин</div><div class=\"scoreboard__table__table-header__item scoreboard__table__table-header__item_alignRight\">Счёт</div></header><div class=\"line line_blue scoreboard__table__line\"></div><div class=\"scoreboard__table__content\">");var i,v,__fest_iterator0;try{__fest_iterator0=scores || {};}catch(e){__fest_iterator={};__fest_log_error(e.message);}for(i in __fest_iterator0){v=__fest_iterator0[i];try{__fest_attrs[0]=__fest_escapeHTML(i % 2 == 0 ? 'scoreboard__table__content__c-line__item_even' : 'scoreboard__table__content__c-line__item_odd')}catch(e){__fest_attrs[0]=""; __fest_log_error(e.message);}__fest_buf+=("<div class=\"scoreboard__table__content__c-line " + __fest_attrs[0] + "\"><div class=\"scoreboard__table__content__c-line__item scoreboard__table__content__c-line__item_name\">");try{__fest_buf+=(__fest_escapeHTML(v.username))}catch(e){__fest_log_error(e.message + "13");}__fest_buf+=("</div>");try{__fest_attrs[0]=__fest_escapeHTML(i % 2 == 0 ? 'vertical-line_green' : '')}catch(e){__fest_attrs[0]=""; __fest_log_error(e.message);}__fest_buf+=("<div class=\"vertical-line vertical-line_tableRelPos scoreboard__table__content__c-line__line " + __fest_attrs[0] + "\"></div><div class=\"scoreboard__table__content__c-line__item scoreboard__table__content__c-line__item_score\">");try{__fest_buf+=(__fest_escapeHTML(v.score))}catch(e){__fest_log_error(e.message + "17");}__fest_buf+=("</div></div>");}__fest_buf+=("</div><div class=\"line line_blue scoreboard__table__line\"></div><button class=\"button button_long smallMargTop js-button-onUpdate\">Обновить</button><button class=\"button button_long smallMargTop js-button-onMain\" data-href=\"#\">На главную</button></div></div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}} ; });
// топ 10 игроков
...
define('joystickTransport',['views/joystick'],function(joystick) {
...
define('views/characters/character',[
    'backbone'
], function(
    Backbone
){
...
define('views/characters/myCharacter',[
    'backbone',
...
define('models/characters/enemyCharacter',[
    'backbone',
    'models/characters/character'
], function(
    Backbone,
...
define('views/characters/enemyCharacter',[
    'backbone',
    'views/characters/character',
...
define('main',['backbone', 'sync', 'router', 'modernizr', 'qrcode'], function(
    Backbone,
    sync,
    router,
    m,
